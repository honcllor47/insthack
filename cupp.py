...
def print_cow():
    ...
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Muris Kurgas |cyberworld5758@gmail.com ]"
    )
    print(28 * " " + "[ Mebus | http://www.cyberworld.tk/]\r\n")
    print(28 * " " + "[Subscribe cyberworld]\r\n")
...
def version():
    ...
    print("	* Hacked up by j0rgan cyberworld5758@gmail.com  -")
